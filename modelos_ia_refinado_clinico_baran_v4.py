...
OUTPUT_XLSX = "Modelos_IA_refinado_clinico_baran_y_respuestas_v4.xlsx"
...
def build_engineered_features(df, qmap):
    ...
    out["Q39_menos"] = df[q39].apply(is_yes).astype(float) if q39 else 0.0
    ...
    # auditory exact coding: 1 one ear, 2 both, 0 none
...
def diagnosis_feature_plan():
    return {
        "IA01_MV": {
            "engineered_num": ["Edad","Edad_lt_50","SVE_like","bloque_migrañoso_n","bloque_migrañoso_2mas","bloque_migrañoso_3mas","giro","nauseas","cabeza_flotando","duracion_intermedia","duracion_larga","frecuencia_baja","frecuencia_alta","Q39_mas"],
        ...
        "IA03_EM": {
            "engineered_num": ["Edad","SVE_like","bloque_auditivo_n","bloque_auditivo_2mas","audicion_peor_ambos","giro","nauseas","duracion_intermedia","duracion_larga"],
...
def main():
    ...
    methodology_df = pd.DataFrame({
        "Paso": [
            "Cohorte","Patron de oro","Base clinica","Recodificacion exacta","Temporalidad/Bárány",
        ...
        "Descripcion": [
            ...
            "Se aplicó la codificación exacta informada por el usuario para Q01, Q02, Q20-24, Q25, Q26 y Q38-41",
